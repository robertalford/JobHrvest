"""
Career Page Finder v4.4 — direct from CareerPageFinderV4.
...
class CareerPageFinderV44(CareerPageFinderV4):
    """v4.4 finder with stronger listing endpoint preference and host-affinity guardrails."""
