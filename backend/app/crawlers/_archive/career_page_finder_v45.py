"""
Career Page Finder v4.5 — direct from CareerPageFinderV4.
...
class CareerPageFinderV45(CareerPageFinderV4):
    """v4.5 finder with stronger listing endpoint preference and host-affinity guardrails."""
