"""
Career Page Finder v4.3 — direct from CareerPageFinderV4.

High-impact improvements:
1. Adds ApplyFlow/jobview-aware listing scoring to prefer concrete listing endpoints.
2. Expands jobs search probe paths for query-driven listing pages.
3. Preserves host-affinity and payload-safe recovery from v4.2.
"""
...
class CareerPageFinderV43(CareerPageFinderV4):
    """v4.3 finder with stronger listing endpoint preference and host-affinity guardrails."""
    ...
    def _listing_page_score_v38(self, url: str, html_body: str) -> float:
        ...
        score += min(jobview_links * 2.0, 26.0)
