"""
Career Page Finder v3.9 — direct from CareerPageFinderV4.

High-impact improvements:
1. Stronger bad-payload recovery for non-HTML/PDF discovery targets.
2. Salesforce portal path probes for `/careers/fRecruit__ApplyJobList`.
3. Oracle tenant-aware requisitions probes using detected `siteNumber` values.
4. Expanded generic listing path probing (`/careers`, `/jobs`, localized paths).
5. Canonical/anchor/query upgrades preserved from v3.8.
"""
...
class CareerPageFinderV39(CareerPageFinderV4):
    """v3.9 finder with payload-safe recovery + Oracle/Salesforce probes."""
