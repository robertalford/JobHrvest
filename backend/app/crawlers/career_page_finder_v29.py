"""
Career Page Finder v2.9 — direct from v1.6 finder base (CareerPageFinderV4).
...
class CareerPageFinderV29(CareerPageFinderV4):
    """v2.9 finder with stronger recovery from wrong discovery targets."""
