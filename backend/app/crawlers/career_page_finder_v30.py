"""
Career Page Finder v3.0 — direct from v1.6 finder base (CareerPageFinderV4).
...
class CareerPageFinderV30(CareerPageFinderV4):
    """v3.0 finder with stronger recovery from wrong discovery targets."""
