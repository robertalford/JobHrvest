...
Test Results: 67% success rate (14/21 sites)
Match breakdown: {"model_only": 6, "both_failed": 2, "model_worse": 4, "model_failed": 5, "model_equal_or_better": 4}
Tier breakdown: {"tier2_heuristic_v16": 14}

## Failures to Analyse

There are 9 sites where the model performed worse than the baseline
...
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_1_virtue_love.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_1_virtue_love_wrapper.json
...
Model: 13 jobs | Tier: tier2_heuristic_v16 | Titles: ['Accounting Intern', 'Content Creator Intern', 'Customer Service Intern']
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_2_cloudcommerce_breezy_hr.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_2_cloudcommerce_breezy_hr_wrapper.json
...
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_3_gtomato_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_3_gtomato_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_3_gtomato_com_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_4_forestandbird_org_nz.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_4_forestandbird_org_nz_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_4_forestandbird_org_nz_wrapper.json
...
Model: 3 jobs | Tier: tier2_heuristic_v16 | Titles: ['Lowongan Kerja', 'Alamat Kantor', 'Model Incubator']
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_5_oveadc_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_5_oveadc_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_5_oveadc_com_wrapper.json
...
Model: 2 jobs | Tier: tier2_heuristic_v16 | Titles: ['General Opportunities', 'NMC Opportunities New York, NY']
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_6_job_boards_greenhouse_io.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_6_job_boards_greenhouse_io_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_6_job_boards_greenhouse_io_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_7_cliqhr_zohorecruit_in.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_7_cliqhr_zohorecruit_in_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_7_cliqhr_zohorecruit_in_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: Page too short (0 bytes), even after Playwright
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_8_odfjelltechnology_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_8_odfjelltechnology_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/failure_8_odfjelltechnology_com_wrapper.json
...
Company: Qlik
Domain: careerhub.qlik.com
Test URL: https://careerhub.qlik.com/careers?start=0&pid=1133910625754&sort_by=hot
Baseline: 0 jobs | Titles: []
Model: 16 jobs | Tier: tier2_heuristic_v16 | Titles: ['Marketing Insights ManagerKing of Prussia, PA, US + 1 moreHybridPosted 17 days a', 'Business Development InternBarcelona, CT, ESHybridPosted 23 days ago', 'Enterprise Account Executive - South AfricaDubai, Dubai, AEPosted 8 days ago']
  Discovery: path_probe_best_guess+playwright → https://careerhub.qlik.com/careers
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/spotcheck_1_careerhub_qlik_com.html

--- Spot-check 2: model_only ---
Company: Jayco Albury Wodonga
Domain: jaycoaw.com.au
Test URL: https://www.jaycoaw.com.au/careers
Baseline: 0 jobs | Titles: []
Model: 3 jobs | Tier: tier2_heuristic_v16 | Titles: ['Qualified Service Technician', 'Apprentice Service Technician', 'MTAA Super Scholarship Recipient']
  Discovery: path_probe_best_guess+playwright → https://www.jaycoaw.com.au/careers
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/spotcheck_2_jaycoaw_com_au.html

--- Spot-check 3: model_only ---
Company: Savour
Domain: savourapp.co
Test URL: https://www.savourapp.co/careers/
Baseline: 0 jobs | Titles: []
Model: 2 jobs | Tier: tier2_heuristic_v16 | Titles: ['Munch Box', 'Mystery Bag']
  Discovery: path_probe_best_guess+playwright → https://savourapp.co/careers/
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9/spotcheck_3_savourapp_co.html
...
Context directory: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_9
...
7. **Create the model** via API:
   ...
   curl -X POST http://localhost:8001/api/v1/ml-models/ -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"name": "3-Tier Hybrid Extractor v1.9", "model_type": "site_job_listings", "description": "YOUR DESCRIPTION OF CHANGES"}'
   ```
