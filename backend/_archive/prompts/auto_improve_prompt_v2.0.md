...
Model: 3-Tier Hybrid Extractor v1.6
Description: v1.6: Apply-button container matching (+20 score when container size matches Apply count). Expanded title rejection (form messages, nav labels, business terms). Post-extraction vocabulary validation (reject containers where <30% titles have job nouns, try next container). Sub-page link following after careers page discovery. Playwright for careers-page.com Angular SPAs. Query param preservation in discovery.
Test Results: 51% success rate (51/100 sites)
Match breakdown: {"partial": 7, "model_only": 16, "both_failed": 35, "model_worse": 8, "model_failed": 14, "model_equal_or_better": 20}
Tier breakdown: {"tier1_ats_lever": 1, "tier2_heuristic_v16": 49, "tier1_ats_greenhouse": 1}
...
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_1_virtue_love.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_1_virtue_love_wrapper.json
...
Model: 13 jobs | Tier: tier2_heuristic_v16 | Titles: ['Accounting Intern', 'Content Creator Intern', 'Customer Service Intern']
  Discovery: domain_root_fallback → https://cloudcommerce.breezy.hr
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_2_cloudcommerce_breezy_hr.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_2_cloudcommerce_breezy_hr_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_2_cloudcommerce_breezy_hr_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  Discovery: homepage_link:Current Vacancies → https://www.forestandbird.org.nz/working-here/current-vacancies
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_3_forestandbird_org_nz.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_3_forestandbird_org_nz_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_3_forestandbird_org_nz_wrapper.json

--- Failure 4: model_worse ---
...
Model: 3 jobs | Tier: tier2_heuristic_v16 | Titles: ['Lowongan Kerja', 'Alamat Kantor', 'Model Incubator']
  Discovery: domain_root_fallback → https://oveadc.com
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_4_oveadc_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_4_oveadc_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_4_oveadc_com_wrapper.json

--- Failure 5: model_failed ---
Company: SAGE Group
Domain: sagehr.my.salesforce-sites.com
Test URL (known from test data): https://sagehr.my.salesforce-sites.com/careers/
Baseline: 10 jobs | Titles: ['.NET Software Engineer', 'Account Executive', 'Account Sales Executive']
  Wrapper selectors: boundary=//tr[contains(@class, 'dataRow')] | title=.//td[2]/span/a
Model: 0 jobs | Tier: None | Titles: []
  Discovery: domain_root_fallback → https://sagehr.my.salesforce-sites.com
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_5_sagehr_my_salesforce_sites_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_5_sagehr_my_salesforce_sites_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_5_sagehr_my_salesforce_sites_com_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  Discovery: homepage_link: → https://cliqhr.zohorecruit.in/recruit/downloadrssfeed?digest=gt.@qBeO5FLbjcQX4pkb1IST9zoqpiDz@7.7wjZLPO4-&embedsource=CareerSite
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_6_cliqhr_zohorecruit_in.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_6_cliqhr_zohorecruit_in_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_6_cliqhr_zohorecruit_in_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  Discovery: homepage_link:Career → https://www.odfjelltechnology.com/career/
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_7_odfjelltechnology_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_7_odfjelltechnology_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_7_odfjelltechnology_com_wrapper.json

--- Failure 8: model_failed ---
Company: Venues Otautahi
Domain: venuesotautahijobs.co.nz
Test URL (known from test data): https://www.venuesotautahijobs.co.nz/search?search=
Baseline: 3 jobs | Titles: ['Event Manager', 'Marketing Manager', 'Casual Chefs']
  Wrapper selectors: boundary=.jobItem | title=.title a span
Model: 0 jobs | Tier: None | Titles: []
  Discovery: homepage_link:Current Opportunities → https://www.venuesotautahijobs.co.nz/search
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_8_venuesotautahijobs_co_nz.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_8_venuesotautahijobs_co_nz_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/failure_8_venuesotautahijobs_co_nz_wrapper.json
...
Company: Jardine Engineering
Domain: jec.com
Test URL: https://www.jec.com/people/#job-openings
Baseline: 12 jobs | Titles: ['Management Trainee (Year 2026)', 'Summer Internship Program (Jun to Aug)', 'Senior Engineer / Engineer (Electrical)']
Model: 17 jobs | Tier: tier2_heuristic_v16 | Titles: ['Management Trainee (Year 2026)', 'Summer Internship Program (Jun to Aug)', 'Senior Engineer / Engineer (Electrical)']
  Discovery: homepage_link:Job Openings → https://www.jec.com/people-2/#job-openings
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/spotcheck_1_jec_com.html

--- Spot-check 2: model_equal_or_better ---
Company: MAQO SOLAR
Domain: maqosolar.com
Test URL: https://maqosolar.com/i-think-the-future-for-solar-energy-is-bright-career/
Baseline: 1 jobs | Titles: ['Technical Engineer']
Model: 2 jobs | Tier: tier2_heuristic_v16 | Titles: ['SEE WHAT PEOPLE SAY ABOUT MAQO AT JobStreet :', 'Available Positions']
  Discovery: homepage_link:Join our Team → https://maqosolar.com/i-think-the-future-for-solar-energy-is-bright-career/
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/spotcheck_2_maqosolar_com.html

--- Spot-check 3: partial ---
Company: SKL Actuarial
Domain: sklactuarial.com.au
Test URL: https://www.sklactuarial.com.au/jobs/
Baseline: 51 jobs | Titles: ['Actuary', 'Expression of Interest – Actuaries Relocating to Asia', 'APS Senior Data Scientist']
Model: 48 jobs | Tier: tier2_heuristic_v16 | Titles: ['Expression of Interest – Actuaries Relocating to Asia', 'APS Senior Data Scientist', 'Pricing Actuary – General Insurance']
  Discovery: homepage_link:Current Opportunities → https://sklactuarial.com/jobs/
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0/spotcheck_3_sklactuarial_com_au.html
...
Context directory: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_0
...
7. **Create the model** via API:
   ...
   curl -X POST http://localhost:8001/api/v1/ml-models/ -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"name": "3-Tier Hybrid Extractor v2.0", "model_type": "site_job_listings", "description": "YOUR DESCRIPTION OF CHANGES"}'
   ```
...
## ⚠️ REGRESSION ALERT
Previous version scored 51%, down from best of 67%.
