...
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_1_virtue_love.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_1_virtue_love_wrapper.json
...
Model: 13 jobs | Tier: tier2_heuristic_v16 | Titles: ['Accounting Intern', 'Content Creator Intern', 'Customer Service Intern']
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_2_cloudcommerce_breezy_hr.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_2_cloudcommerce_breezy_hr_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_2_cloudcommerce_breezy_hr_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_3_forestandbird_org_nz.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_3_forestandbird_org_nz_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_3_forestandbird_org_nz_wrapper.json
...
Model: 3 jobs | Tier: tier2_heuristic_v16 | Titles: ['Lowongan Kerja', 'Alamat Kantor', 'Model Incubator']
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_4_oveadc_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_4_oveadc_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_4_oveadc_com_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_5_sagehr_my_salesforce_sites_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_5_sagehr_my_salesforce_sites_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_5_sagehr_my_salesforce_sites_com_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_6_cliqhr_zohorecruit_in.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_6_cliqhr_zohorecruit_in_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_6_cliqhr_zohorecruit_in_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_7_odfjelltechnology_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_7_odfjelltechnology_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_7_odfjelltechnology_com_wrapper.json
...
Model: 0 jobs | Tier: None | Titles: []
  ...
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_8_venuesotautahijobs_co_nz.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_8_venuesotautahijobs_co_nz_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/failure_8_venuesotautahijobs_co_nz_wrapper.json
...
Test URL: https://jobs.lever.co/bisnow
Baseline: 1 jobs | Titles: ['Entry-level Account Manager']
Model: 34 jobs | Tier: tier1_ats_lever | Titles: ['Entry-level Account Manager', 'Denver Freelance Reporter', 'Marketing Coordinator - Email Marketing']
  Discovery: ats_slug:lever.co → https://jobs.lever.co/bisnow
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/spotcheck_1_jobs_lever_co.html

--- Spot-check 2: model_only ---
Company: Talent Web Recruitment
Domain: talentweb.com.au
Test URL: https://www.talentweb.com.au/jobs
Baseline: 0 jobs | Titles: []
Model: 2 jobs | Tier: tier2_heuristic_v16 | Titles: ['Connecting top companies, with the top talent.', 'POWERED BY']
  Discovery: homepage_link:Search JobsView our listed job → https://www.talentweb.com.au/jobs/
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/spotcheck_2_talentweb_com_au.html

--- Spot-check 3: model_equal_or_better ---
Company: Juvare
Domain: job-boards.greenhouse.io
Test URL: https://job-boards.greenhouse.io/embed/job_board?for=juvare&validityToken=Hl9jSEoYw1bv0p3xIPVgWgMod3sf_qo7o-4h6P0Abavm55qEnO9KBYcabBcCwsaxpyYBmhH4i2tJAWf6iIlMqyFobBRYnbhLZaOKEPE4wxJVT21RroVht-lNa65QlsHImffuOcUKvBZkQmzlfQNnZ9lXujoTdbJmsMKL2P1c3UNHcL7htz1o4FrmOUYjES2OT-HmSZtzjcn4MQZ7z1Zf_7k6FXJtzeUGFgReudRGPfT6nLsoyiMhYmwPAhC4WTwMg-XegBHxUW3dFzY308sDrjXCqWSgU6LRR2GdwyZCrnnzer5UGt2F0XbqYe7fhDyIZvQLi93a859NUt3B7lpEBA%3D%3D
Baseline: 10 jobs | Titles: ['Automation Test Engineer', 'DevOps Engineer', 'Lead Automation Test Engineer']
Model: 10 jobs | Tier: tier1_ats_greenhouse | Titles: ['Automation Test EngineerVijayawada, India', 'DevOps EngineerVijayawada', 'Lead Automation Test EngineerVijayawada, India']
  Discovery: ats_slug:greenhouse.io → https://job-boards.greenhouse.io/embed/job_board?for=juvare
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7/spotcheck_3_job_boards_greenhouse_io.html
...
Context directory: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v1_7
...
7. **Create the model** via API:
   ...
   curl -X POST http://localhost:8001/api/v1/ml-models/ -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"name": "3-Tier Hybrid Extractor v1.7", "model_type": "site_job_listings", "description": "YOUR DESCRIPTION OF CHANGES"}'
   ```
...
6. **Best accuracy: 66% (v1.6).** You MUST beat or match this.
7. **Use `python3`.** Playwright is on the host: `python3 backend/scripts/inspect_site.py <url> -f`

## ⚠️ REGRESSION ALERT
Previous version scored 51%, down from best of 66%.
