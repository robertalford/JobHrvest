...
Model: 3-Tier Hybrid Extractor v2.2
Description: v2.2: finder v9 listing-page repair (documents/detail->listing, Teamtailor and Simple Job Board normalization, stronger vacancies promotion), extractor v22 nav-false-positive suppression, stricter tiny-set detail-link gating, Next.js replay with Playwright, and Azendian news-list structured extraction.
Test Results: 27% success rate (3/11 sites)
Match breakdown: {"model_only": 1, "both_failed": 4, "model_failed": 4, "model_equal_or_better": 2}
Tier breakdown: {"tier2_heuristic_v17": 3}

## Failures to Analyse

There are 4 sites where the model performed worse than the baseline
or failed entirely. Below are the details with HTML snippets for analysis.


--- Failure 1: model_failed ---
Company: Tasisoluciones
Domain: tasisoluciones.com
Test URL (known from test data): https://www.tasisoluciones.com/ACQ_Bolsa/Vacantes?idcategoria=-1
Baseline: 2 jobs | Titles: ['Auxiliar Contable', 'Administrador jr Infraestructura']
  Wrapper selectors: boundary=.//div/div/div/div/div/div[1]/h4 | title=.
Model: 0 jobs | Tier: None | Titles: []
  Discovery: domain_root_fallback → https://tasisoluciones.com
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_1_tasisoluciones_com.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_1_tasisoluciones_com_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_1_tasisoluciones_com_wrapper.json

--- Failure 2: model_failed ---
Company: Sunshine Coast Council
Domain: careers.sunshinecoast.qld.gov.au
Test URL (known from test data): https://careers.sunshinecoast.qld.gov.au
Baseline: 6 jobs | Titles: ['Expression of Interest - Exclusive opportunities for First Nations people', 'Parks Field Leader x 2', 'Parks Supervisor']
  Wrapper selectors: boundary=div.JobCard | title=h3
Model: 0 jobs | Tier: None | Titles: []
  Discovery: None → None
  Error: Phase timeout (60s)
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_2_careers_sunshinecoast_qld_gov_.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_2_careers_sunshinecoast_qld_gov__wrapper.json

--- Failure 3: model_failed ---
Company: Global Airfreight International Pte Ltd
Domain: globalair.com.sg
Test URL (known from test data): https://www.globalair.com.sg/career
Baseline: 7 jobs | Titles: ['1) Officer/ Executive -\xa0Import/Export Operation', '2) Officer / Executive – Inside Sales', '\u200b\u200b\u200b\u200b\u200b3) Business Development Officer/Executive – NSD']
  Wrapper selectors: boundary=//table//tbody/tr[3]/td/p[.//b] | title=.
Model: 0 jobs | Tier: None | Titles: []
  Discovery: homepage_link:Careers+repair_v8:careers_suffix:/careers-1+playwright_v8 → https://www.globalair.com.sg/careers-1
  Error: None
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_3_globalair_com_sg.html
  HTML (baseline's test URL):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_3_globalair_com_sg_baseline.html
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_3_globalair_com_sg_wrapper.json

--- Failure 4: model_failed ---
Company: Humanforce
Domain: livehire.com
Test URL (known from test data): https://www.livehire.com/careers/humanforce/jobs
Baseline: 10 jobs | Titles: ['Project ManagerHybrid', 'Implementation Consultant - WFMHybrid', 'Implementation Consultant - HRHybrid']
  Wrapper selectors: boundary=//job-listing/parent::a | title=.//h3
Model: 0 jobs | Tier: None | Titles: []
  Discovery: None → None
  Error: Phase timeout (60s)
Context files (READ THESE for full analysis):
  HTML (model's discovered page): /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_4_livehire_com.html
  HTML (baseline's test URL):     same as above
  Full wrapper config (JSON):     /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/failure_4_livehire_com_wrapper.json
...
Company: Middy's
Domain: middys.connxcareers.com
Test URL: https://middys.connxcareers.com/
Baseline: 0 jobs | Titles: []
Model: 5 jobs | Tier: tier2_heuristic_v17 | Titles: ['Store Person / Driver - Palmerston - NT', 'Store Person / Driver - Heidelberg - VIC', 'Inventory / Purchasing Officer - Hallam - VIC']
  Discovery: domain_root_fallback → https://middys.connxcareers.com
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/spotcheck_1_middys_connxcareers_com.html

--- Spot-check 2: model_equal_or_better ---
Company: HMSHost
Domain: careers.hmshost.com
Test URL: https://careers.hmshost.com/jobs
Baseline: 12 jobs | Titles: ['Shift Manager I', 'Cook', 'Crew Member']
Model: 18 jobs | Tier: tier2_heuristic_v17 | Titles: ['Shift Manager I', 'HMSHost at Jersey Gardens Mall', 'Crew Member']
  Discovery: careers_subdomain:careers+subpage:href_match+subpage_v5:href_match_v5+repair_v8:detail_probe_v8:/jobs/search → https://careers.hmshost.com/jobs/search
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/spotcheck_2_careers_hmshost_com.html

--- Spot-check 3: model_equal_or_better ---
Company: Fedex Australia
Domain: tnt.currentjobs.co
Test URL: https://tnt.currentjobs.co/Job/Index
Baseline: 30 jobs | Titles: ['Owner Driver', 'Operations Supervisor (PM Shift)', 'Owner Driver SpS']
Model: 30 jobs | Tier: tier2_heuristic_v17 | Titles: ['Owner Driver', 'Operations Supervisor (PM Shift)', 'Owner Driver SpS']
  Discovery: homepage_link:Vacancies → https://tnt.currentjobs.co/Job
  HTML file: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3/spotcheck_3_tnt_currentjobs_co.html
...
Context directory: /home/moonlight-admin/Documents/Server-Apps/moonlight/Services/jobharvest/storage/auto_improve_context/v2_3
...
7. **Create the model** via API:
   ...
   curl -X POST http://localhost:8001/api/v1/ml-models/ -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{"name": "3-Tier Hybrid Extractor v2.3", "model_type": "site_job_listings", "description": "YOUR DESCRIPTION OF CHANGES"}'
   ```
